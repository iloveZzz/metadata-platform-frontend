...
box-shadow: 0 0 0 3px
  color-mix(in srgb, var(--primary-color, #3371ff) 15%, transparent);
```
...
- 必须优先让 `YButton`、`YTable`、`YTree`、`YssFormily` 和 Ant Design Vue 组件消费 ConfigProvider 主题；非必要不覆盖其主色样式。
