...
import { YCard, YButton, YConditionBuilder, YssFormily } from '@yss-ui/components';
  ...
  <div class="complex-form-create">
    ...
    <YCard class="content-card">
      ...
      <div v-show="currentStep === RULE_STEPS.RULE_CONFIG">
        <YssFormily ref="ruleConfigFormRef" v-model="formData" :schema="ruleConfigSchemaComputed">
          <!-- 插槽1：校验范围构建器 -->
